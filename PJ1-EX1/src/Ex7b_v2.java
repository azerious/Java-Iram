public class Ex7b_v2 {
	...
	public static void main(String[] args) {
		...
		dblBrutPrice = Utilities.getUser_doubleInput("Entrez le prix brut");// PERMET D APPELLER UNE FONCTION DANS LA CLASSE UTILITIES ==> Utilities.leNomDeLaFonction
		VATValue = Utilities.getUser_doubleInput("Entrez la TVA");
