public class Ex7b_v2 {
	...
	public static void main(String[] args) {
		...
		dblBrutPrice = Utilities.getUserMultipleInputDouble("Entrez le prix brut");// PERMET D APPELLER UNE FONCTION DANS LA CLASSE UTILITIES ==> Utilities.leNomDeLaFonction
		VATValue = Utilities.getUserMultipleInputDouble("Entrez la TVA");
